...
@section ('contenido')
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <div class="form-group">
                <div class="input-group">
                    <input id="buscador" onkeyup="buscadorindex()" type="text" class="form-control" name="searchText"
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="text-right">
            <a href="{{url('mantenimiento/create')}}">
                        ...
                        <tr class="item">
                            ...
                            <td>
                                @if($a->estatus == 1)
                                    ...
                                    <a class="linea btn btn-info"
                                       href="{{ URL::action('Backend\MantenimientoController@edit', $a->id_mantenimiento) }}"><i
