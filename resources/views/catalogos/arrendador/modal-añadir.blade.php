<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-telefono">
    {!! Form::model($arrendador, ['method' => 'POST', 'url' =>['catalogos/arrendador/telefono', $arrendador->id_cat_arrendador]]) !!}
    {{Form::token()}}
...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-email">
    {!! Form::model($arrendador, ['method' => 'POST', 'url' =>['catalogos/arrendador/email', $arrendador->id_cat_arrendador]]) !!}
    {{Form::token()}}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-banco">
    {!! Form::model($arrendador, ['method' => 'POST', 'url' =>['catalogos/arrendador/banco', $arrendador->id_cat_arrendador]]) !!}
    {{Form::token()}}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
