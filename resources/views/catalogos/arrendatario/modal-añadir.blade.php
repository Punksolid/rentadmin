<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-telefono">
    {!! Form::model($arrendatario, ['method' => 'POST', 'url' =>['catalogos/arrendatario/telefono', $arrendatario->id_cat_arrendatario]]) !!}
    {{Form::token()}}
...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-telefonofiador">
    {!! Form::model($fiador, ['method' => 'POST', 'url' =>['catalogos/arrendatario/telefonofiador', $fiador->id_cat_fiadores]]) !!}
    {{Form::token()}}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-add-email">
    {!! Form::model($arrendatario, ['method' => 'POST', 'url' =>['catalogos/arrendatario/email', $arrendatario->id_cat_arrendatario]]) !!}
    {{Form::token()}}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
